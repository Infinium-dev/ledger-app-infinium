...
//    menu,         callback, userid, icon,              line1,     line2, text_x, icon_x
    ...
    { NULL,         os_sched_exit, 0, /*&C_icon_dashboard*/ NULL, "Quit app", NULL, 0,     0 },
    UX_MENU_END
};
...
const ux_menu_entry_t ui_menu_info[] = {
    ...
    {NULL, NULL, -1, NULL, "(c) Infinium developers (c) Bytecoin developers ", NULL, 22, 0},
    {NULL, NULL, -1, NULL, "Version " XSTR(BYTECOIN_VERSION), NULL, 0, 0},
    {NULL, NULL, -1, NULL, XSTR(BYTECOIN_SPEC_VERSION), NULL, 0, 0},
    {NULL, ui_menu_main_display, 1, NULL /* &C_badge_back*/, "Back", NULL, 0, 0},
    UX_MENU_END};
